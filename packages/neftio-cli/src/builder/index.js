  ...
  const defaultWebpackConfig = {
    ...
    module: {
      rules: [
        ...
        {
          test: /\.(xhtml|html|nml)$/,
          loader: require.resolve('@neftio/webpack-loader'),
          options: {
        ...
        },
        {
          ...
          use: [require.resolve('@neftio/webpack-coffee-loader')],
        },
      ],
    },
  }
