...
const log = require('@neftio/core/src/log').scope('build:static')
const { Resources, Resource } = require('@neftio/core/src/resources')
...
exports.loadStaticFiles = async () => {
  ...
  return `const { resources } = require('@neftio/core')
const { Resources } = require('@neftio/core/src/resources')
