    ...
    private final class CallFunctionAction extends ReaderActionHandler {
        ...
        public void accept(Reader reader) {
            ...
            if (func != null) {
                ...
                Log.w("Neftio", "Native function '" + name + "' not found");
            }
        }
    }
    ...
    private void processActions(byte[] actionsArr, Reader reader) {
        for (byte actionIndex : actionsArr) {
            ...
            if (action != null) {
                ...
                Log.e("Neftio", "Native action '" + InActionValues[actionIndex] + "' is not implemented");
            }
        }
    }
        ...
        if (args != null) {
            ...
            for (Object arg : args) {
                if (arg == null) {
                    ...
                    pushInteger(EVENT_NULL_TYPE);
                    Log.e("Neftio", "Event can be pushed with a boolean, float or a string, "
