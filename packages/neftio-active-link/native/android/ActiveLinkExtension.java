...
public final class ActiveLinkExtension {
    ...
    public static void web(String url) {
        ...
        try {
            ...
            Log.e("Neftio", "Cannot web in ActiveLink extension", error);
        }
    }
    ...
    public static void mailto(String address) {
        ...
        try {
            ...
            Log.e("Neftio", "Cannot mailto in ActiveLink extension", error);
        }
    }
    ...
    public static void tel(String number) {
        ...
        try {
            ...
            Log.e("Neftio", "Cannot tel in ActiveLink extension", error);
        }
    }
    ...
    public static void geo(Float latitude, Float longitude, String address) {
        ...
        try {
            ...
            Log.e("Neftio", "Cannot geo in ActiveLink extension", error);
        }
    }
}
