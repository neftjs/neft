...
(function() {
  ...
  module.exports = function(impl) {
    var DATA, ImageResourceRequest, Item, cache, callCallback, createImage, getImage, onImageLoaded, round, setBackgroundSize, useCssBackground;
    Item = impl.Types.Item;
    round = Math.round;
    cache = Object.create(null);
    createImage = function(src, rsc) {
      var img, obj;
      ...
      img.addEventListener('load', function() {
        var xhr;
        obj.status = 'ready';
        obj.width = (rsc != null ? rsc.width : void 0) || this.naturalWidth || this.width;
        obj.height = (rsc != null ? rsc.height : void 0) || this.naturalHeight || this.height;
    ...
    return {
      ...
      setStaticImagePixelRatio: function(val) {
        return ImageResourceRequest.resolution = (window.devicePixelRatio || 1) * val;
      },
      setImageSource: function(val, callback) {
        var data, rsc, _ref;
        if (rsc = (_ref = impl.Renderer.resources) != null ? _ref.getResource(val) : void 0) {
...
(function() {
  ...
  module.exports = function(impl) {
    ...
    return exports = {
      ...
      setTextColor: function(val) {
        var _ref1;
        val = ((_ref1 = impl.Renderer.resources) != null ? _ref1.resolve(val, COLOR_RESOURCE_REQUEST) : void 0) || val;
      ...
      setTextLinkColor: (function() {
        ...
        return function(val) {
          var data, _ref1;
          val = ((_ref1 = impl.Renderer.resources) != null ? _ref1.resolve(val, RSC_REQ) : void 0) || val;
          data = this._impl;
          if (!data.stylesheet) {
...
(function() {
  ...
  module.exports = function(impl) {
    var COLOR_RESOURCE_REQUEST, DATA, SHEET, implUtils, reloadFontFamily, round, updateVerticalAlignment;
    implUtils = impl.utils;
    round = Math.round;
    ...
    return {
      ...
      setTextInputColor: function(val) {
        var _ref;
        val = ((_ref = impl.Renderer.resources) != null ? _ref.resolve(val, COLOR_RESOURCE_REQUEST) : void 0) || val;
        this._impl.innerElemStyle.color = val;
      },
      setTextInputLineHeight: function(val) {
        this._impl.innerElemStyle.lineHeight = val;
...
(function() {
  'use strict';
  module.exports = function(impl) {
    var BORDER_COLOR_RESOURCE_REQUEST, COLOR_RESOURCE_REQUEST, DATA, Item, div, round;
    Item = impl.Types.Item;
    round = Math.round;
    DATA = {
      innerElem: null,
    ...
    return {
      ...
      setRectangleBorderColor: function(val) {
        var _ref;
        val = ((_ref = impl.Renderer.resources) != null ? _ref.resolve(val, BORDER_COLOR_RESOURCE_REQUEST) : void 0) || val;
