...
return module.exports;
})();modules['../db/implementations/browser/localStorage.coffee'] = (function(){
var module = {exports: modules["../db/implementations/browser/localStorage.coffee"]};
var require = getModule.bind(null, {"utils":"../utils/index.coffee.md"});
var exports = module.exports;
...
return module.exports;
})();modules['../networking/impl/browser/index.coffee'] = (function(){
var module = {exports: modules["../networking/impl/browser/index.coffee"]};
var require = getModule.bind(null, {"utils":"../utils/index.coffee.md","./request.coffee":"../networking/impl/browser/request.coffee","./response.coffee":"../networking/impl/browser/response.coffee"});
var exports = module.exports;
  ...
  module.exports = function(Networking) {
    ...
    return {
      ...
      init: function(networking) {
        var isReady, onLoaded;
        isReady = false;
        impl.changePage = window.location.neftChangePage = function(uri) {
          var res;
          return res = networking.createLocalRequest({
        ...
        window.addEventListener('popstate', function() {
          if (isReady) {
            return impl.changePage(location.pathname + location.search);
          }
        });
        document.addEventListener('click', function(e) {
          var target;
          target = e.target;
          if (target.nodeName !== 'A' || target.getAttribute('target')) {
            return;
          }
          if (target.href.indexOf(networking.url) === 0 && !/^\/static\//.test(target.pathname)) {
            e.preventDefault();
            return impl.changePage(target.pathname + target.search);
          }
        });
        onLoaded = function() {
...
var require = getModule.bind(null, {"utils":"../utils/index.coffee.md","/Users/krystian/Projects/Neft/app/node_modules/assert":"../assert/index.coffee.md","assert":"../assert/index.coffee.md","./impl/browser/index":"../networking/impl/browser/index.coffee"});
var exports = module.exports;
...
return module.exports;
})();modules['../networking/impl/browser/request.coffee'] = (function(){
var module = {exports: modules["../networking/impl/browser/request.coffee"]};
var require = getModule.bind(null, {});
var exports = module.exports;
...
return module.exports;
})();modules['../renderer/impl/css/index.coffee'] = (function(){
var module = {exports: modules["../renderer/impl/css/index.coffee"]};
var require = getModule.bind(null, {"utils":"../utils/index.coffee.md","./utils":"../renderer/impl/css/utils.coffee","./level0/item":"../renderer/impl/css/level0/item.coffee","./level0/image":"../renderer/impl/css/level0/image.coffee","./level0/text":"../renderer/impl/css/level0/text.coffee","./level0/textInput":"../renderer/impl/css/level0/textInput.coffee","./level0/loader/font":"../renderer/impl/css/level0/loader/font.coffee","./level0/loader/resources":"../renderer/impl/css/level0/loader/resources.coffee","./level0/device":"../renderer/impl/css/level0/device.coffee","./level0/screen":"../renderer/impl/css/level0/screen.coffee","./level0/navigator":"../renderer/impl/css/level0/navigator.coffee","./level0/sensor/rotation":"../renderer/impl/css/level0/sensor/rotation.coffee","./level1/rectangle":"../renderer/impl/css/level1/rectangle.coffee","./level2/scrollable":"../renderer/impl/css/level2/scrollable.coffee","./level0/sound/ambient":"../renderer/impl/css/level0/sound/ambient.coffee"});
var exports = module.exports;
...
(function() {
  ...
  SHEET = "#hatchery { visibility: hidden; } #hatchery span { display: inline-block; } * { margin: 0; padding: 0; -webkit-tap-highlight-color: rgba(255, 255, 255, 0) !important; -webkit-focus-ring-color: rgba(255, 255, 255, 0) !important; outline: none !important; } #styles { position: absolute; width: 100%; height: 100%; overflow: hidden; top: 0; left: 0 } html, body { height: 100%; margin: 0; padding: 0; -webkit-overflow-scrolling: touch; } #body { position: absolute; z-index: 0; } #styles div, #styles span, #styles canvas, #styles img, #styles textarea, #styles input { position: absolute; } #styles span span { position: static; } span * { display: inline; font-weight: inherit; font-size: inherit; font-family: inherit; font-style: inherit; border: 0; background: none; } span b, span strong { font-weight: bolder; } span i, span em { font-style: italic; } code { white-space: pre; } img { width: 100%; height: 100%; pointer-events: none; } .link { position: absolute; width: 100%; height: 100%; z-index: 1; } .rect { width: 100%; height: 100%; box-sizing: border-box; border: 0 solid transparent; } .unselectable, .unselectable:focus { -webkit-touch-callout: none; -webkit-user-select: none; -khtml-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; outline-style:none; } .layer { -moz-perspective: 1px; /* Firefox */ -webkit-transform-style: preserve-3d; /* Safari */ -webkit-perspective: 1px; /* Safari */ -webkit-backface-visibility: hidden; /* Safari, Chrome */ }";
...
return module.exports;
})();modules['../renderer/impl/css/utils.coffee'] = (function(){
var module = {exports: modules["../renderer/impl/css/utils.coffee"]};
var require = getModule.bind(null, {"signal":"../signal/index.coffee.md"});
var exports = module.exports;

(function() {
  'use strict';
  var isFirefox, signal, transformCSSProp, transformProp;
  ...
  exports.keysEvents = (function() {
    ...
    window.addEventListener('keydown', function(e) {
      ...
      pressedKeys[key] = e;
      return (_ref = keysEvents.focusedKeys) != null ? _ref.onPress.emit({
        key: key
      }) : void 0;
    });
    window.addEventListener('keydown', function(e) {
      ...
      code = e.which || e.keyCode;
      key = SPECIAL_KEY_CODES[code] || String.fromCharCode(code);
      return (_ref = keysEvents.focusedKeys) != null ? _ref.onHold.emit({
        key: key
      }) : void 0;
    });
    window.addEventListener('keyup', function(e) {
      ...
      return (_ref = keysEvents.focusedKeys) != null ? _ref.onRelease.emit({
        key: key
      }) : void 0;
    });
    window.addEventListener('keypress', function(e) {
      ...
      return (_ref = keysEvents.focusedKeys) != null ? _ref.onInput.emit({
        text: text
      }) : void 0;
    });
    return keysEvents = {
      ...
      setItemKeysFocus: function(val) {
        ...
        } else if (keysEvents.focusedKeys === keys) {
...
return module.exports;
})();modules['../renderer/impl/css/level0/item.coffee'] = (function(){
var module = {exports: modules["../renderer/impl/css/level0/item.coffee"]};
var require = getModule.bind(null, {"utils":"../utils/index.coffee.md","../utils":"../renderer/impl/css/utils.coffee","log":"../log/index.coffee.md","signal":"../signal/index.coffee.md"});
var exports = module.exports;
...
(function() {
  ...
  module.exports = function(impl) {
    var DATA, LAYER_GC_DELAY, LAYER_MIN_OPERATIONS, NOP, USE_GPU, layers, rad2deg, round, transformProp, updateTransforms, _ref;
    LAYER_MIN_OPERATIONS = 8;
    LAYER_GC_DELAY = 1000;
    USE_GPU = impl.utils.transform3dSupported;
    layers = [];
    _ref = impl.utils, transformProp = _ref.transformProp, rad2deg = _ref.rad2deg;
    ...
    return {
      ...
      create: function(data) {
        ...
        return data.elemStyle = data.elem.style;
      },
      setItemParent: function(val) {
        var elem, self, _ref1;
        self = this;
        ...
        if (val) {
          ...
          if ((_ref1 = elem.parentElement) != null) {
            _ref1.removeChild(elem);
          }
        }
      ...
      setItemBackground: function(val) {
        ...
        if (((_ref1 = (oldElem = (_ref2 = this._background) != null ? _ref2._impl.elem : void 0)) != null ? _ref1.parentNode : void 0) === this._impl.elem) {
          this._impl.elem.removeChild(oldElem);
        }
        if (val) {
          implUtils.prependElement(this._impl.elem, val._impl.elem);
        }
      },
      setItemVisible: function(val) {
      ...
      setItemX: function(val) {
        this._impl.x = round(val);
        updateTransforms(this._impl);
      },
      setItemY: function(val) {
        this._impl.y = round(val);
        updateTransforms(this._impl);
      },
      setItemZ: function(val) {
        this._impl.elemStyle.zIndex = val === 0 ? 'auto' : val;
      },
      setItemScale: function(val) {
      ...
      setItemLinkUri: function(val) {
        var elem;
        if (!this._impl.linkElem) {
          elem = this._impl.linkElem = document.createElement('a');
          elem.setAttribute('class', 'link');
          this._impl.elem.appendChild(elem);
        }
        if (this._impl.linkElem.getAttribute('href') !== val) {
          this._impl.linkElem.setAttribute('href', val);
          this._impl.linkElem.style.display = val !== '' ? 'block' : 'none';
        }
      },
...
return module.exports;
})();modules['../renderer/impl/css/level0/image.coffee'] = (function(){
var module = {exports: modules["../renderer/impl/css/level0/image.coffee"]};
var require = getModule.bind(null, {"signal":"../signal/index.coffee.md"});
var exports = module.exports;
...
(function() {
  ...
  module.exports = function(impl) {
    var DATA, Item, cache, callCallback, createImage, getImage, onImageLoaded, round, setBackgroundSize, useCssBackground;
    ...
    callCallback = function() {
      var callback, data, img, _ref;
      data = this._impl;
      img = data.image;
      callback = data.callback;
      if (!data.useCssBackground) {
        if ((_ref = data.innerElem) != null) {
          _ref.style.display = img.status === 'ready' ? 'block' : 'none';
        }
      }
      if (img.status === 'ready') {
        if (callback != null) {
        ...
        img.onLoaded(onImageLoaded, this);
      }
    };
    useCssBackground = function(item) {
      var data;
      data = item._impl;
    ...
    setBackgroundSize = function(item, width, height) {
      var data;
      data = item._impl;
      if (!data.useCssBackground) {
    ...
    return {
      ...
      setImageSourceWidth: function(val) {
        var data;
        data = this._impl;
        if (data.image && val > 0 && val !== data.image.width) {
          setBackgroundSize(this, val, this._sourceHeight);
        }
      },
      setImageSourceHeight: function(val) {
        var data;
        data = this._impl;
        if (data.image && val > 0 && val !== data.image.height) {
          setBackgroundSize(this, this._sourceWidth, val);
        }
      },
      setImageFillMode: function(val) {
        var data;
...
return module.exports;
})();modules['../renderer/impl/css/level0/text.coffee'] = (function(){
var module = {exports: modules["../renderer/impl/css/level0/text.coffee"]};
var require = getModule.bind(null, {"utils":"../utils/index.coffee.md","signal":"../signal/index.coffee.md"});
var exports = module.exports;
...
(function() {
  ...
  module.exports = function(impl) {
    var CONTAINS_HTML_RE, DATA, Image, Item, SHEET, exports, fontSizes, getTextSizeWidth, hatchery, implUtils, isFontReady, loadingTextsByFonts, reloadFontFamily, reloadFontFamilyQueue, round, updateContent, updateHTMLTextSize, updatePlainTextSize, updateTextStyle, _ref;
    ...
    implUtils.onFontLoaded(function(name) {
      var arr, char, font, item, sizes, _i, _len;
    ...
    return exports = {
      ...
      create: function(data) {
        ...
        if (impl.utils.loadingFonts['sans-serif'] > 0) {
          return impl.utils.onFontLoaded(reloadFontFamily, this);
        }
      },
      setText: function(val) {
...
return module.exports;
})();modules['../renderer/impl/css/level0/textInput.coffee'] = (function(){
var module = {exports: modules["../renderer/impl/css/level0/textInput.coffee"]};
var require = getModule.bind(null, {"signal":"../signal/index.coffee.md"});
var exports = module.exports;
...
(function() {
  ...
  module.exports = function(impl) {
    var DATA, SHEET, implUtils, reloadFontFamily, round, updateVerticalAlignment;
    implUtils = impl.utils;
    round = Math.round;
    SHEET = "textarea, input[type=password] {\n	width: 100%;\n	height: 100%;\n	resize: none;\n	background: none;\n	border: none;\n	box-sizing: border-box;\n	font-size: 14px;\n	line-height: 1;\n	font-family: " + impl.utils.DEFAULT_FONTS['sans-serif'] + ", sans-serif;\n}\ninput[type=password] {\n	padding-top: 0 !important;\n}";
    window.addEventListener('load', function() {
      var styles;
      styles = document.createElement('style');
      styles.innerHTML = SHEET;
      return document.body.appendChild(styles);
    });
    reloadFontFamily = function(family) {
      if ((this._font && this._font._family === family) || (!this._font && family === 'sans-serif')) {
        this._impl.innerElemStyle.fontFamily = this._impl.innerElemStyle.fontFamily;
    ...
    updateVerticalAlignment = function(textInput) {
      var data, freeSpace, lineHeightPx, linesLength, padding, verticalAlignment, _ref, _ref1;
      data = this._impl;
      verticalAlignment = data.verticalAlignment;
      if (verticalAlignment === 'top') {
        padding = 0;
      } else {
        lineHeightPx = this._lineHeight * (((_ref = this._font) != null ? _ref._pixelSize : void 0) || 14);
        linesLength = (((_ref1 = data.innerElem.value.match(/\n/g)) != null ? _ref1.length : void 0) || 0) + 1;
        freeSpace = Math.max(0, this._height - linesLength * lineHeightPx);
      ...
      return data.innerElemStyle.paddingTop = "" + padding + "px";
    };
    DATA = {
      isMultiLine: false,
      textareaElem: null,
    ...
    return {
      ...
      create: function(data) {
        ...
        data.elem.addEventListener('keydown', function(e) {
          var _ref;
          if (!data.isMultiLine && (((_ref = window.event) != null ? _ref.keyCode : void 0) || e.which) === 13) {
        ...
        innerElem.addEventListener('blur', function(e) {
          if (self.keys.focus) {
            return data.innerElem.focus();
          }
        });
        this.keys.onFocusChange(function(oldVal) {
          return data.innerElem[!oldVal ? 'focus' : 'blur']();
        });
        innerElem.addEventListener('input', function() {
          var value;
        ...
        impl.setItemWidth.call(this, 100);
        impl.setItemHeight.call(this, 50);
        if (impl.utils.loadingFonts['sans-serif'] > 0) {
          impl.utils.onFontLoaded(reloadFontFamily, this);
        }
        return this.onHeightChange(updateVerticalAlignment);
      },
      setTextInputText: function(val) {
        if (this._impl.innerElem.value !== val) {
          this._impl.innerElem.value = val;
        }
        updateVerticalAlignment.call(this);
      },
      setTextInputColor: function(val) {
        this._impl.innerElemStyle.color = val;
      },
      ...
      setTextInputEchoMode: function(val) {
        ...
        switch (val) {
          case 'normal':
            ...
            if (this._background) {
              implUtils.insertAfter(data.innerElem, this._background._impl.elem);
            } else {
          ...
          case 'password':
            ...
            data.elem.removeChild(data.innerElem);
            if (this._background) {
              implUtils.insertAfter(input, this._background._impl.elem);
            } else {
      ...
      setTextInputAlignmentVertical: function(val) {
        this._impl.verticalAlignment = val;
        updateVerticalAlignment.call(this);
      }
    };
  };
...
return module.exports;
})();modules['../renderer/impl/css/level0/loader/font.coffee'] = (function(){
var module = {exports: modules["../renderer/impl/css/level0/loader/font.coffee"]};
  ...
  module.exports = function(impl) {
    ...
    return {
      loadFont: function(name, source, sources) {
        ...
        if ((_base = implUtils.loadingFonts)[name] == null) {
          _base[name] = 0;
        }
...
return module.exports;
})();modules['../renderer/impl/css/level0/loader/resources.coffee'] = (function(){
var module = {exports: modules["../renderer/impl/css/level0/loader/resources.coffee"]};
var require = getModule.bind(null, {});
var exports = module.exports;
...
(function() {
  ...
  module.exports = function(impl) {
    return {
      loadResources: function(resources) {
        var length, load, loaded, onLoaded, self;
        self = this;
        length = 1;
        loaded = 0;
        onLoaded = function() {
        ...
        load = function() {
          var img, path, resolution, resolutions, resource, _, _i, _len, _ref;
          if (document.readyState === 'complete') {
...
return module.exports;
})();modules['../renderer/impl/css/level0/device.coffee'] = (function(){
var module = {exports: modules["../renderer/impl/css/level0/device.coffee"]};
var require = getModule.bind(null, {});
var exports = module.exports;
  ...
  module.exports = function(impl) {
    ...
    getNormalizedEvent = (function() {
      ...
      getDeltas = function(e) {
        ...
        x = (_ref = -e.deltaX * 3 || e.wheelDeltaX) != null ? _ref : 0;
        y = ((_ref1 = (_ref2 = -e.deltaY * 3 || e.wheelDeltaY) != null ? _ref2 : e.wheelDelta) != null ? _ref1 : -e.detail * 3) || 0;
    ...
    return {
      initDeviceNamespace: function() {
        ...
        updatePointerEvent = function(event) {
          var obj, _ref, _ref1;
          obj = ((_ref = event.touches) != null ? _ref[0] : void 0) || ((_ref1 = event.changedTouches) != null ? _ref1[0] : void 0) || event;
          pointer.x = obj.pageX;
          pointer.y = obj.pageY;
        };
        (function() {
...
return module.exports;
})();modules['../renderer/impl/css/level0/screen.coffee'] = (function(){
var module = {exports: modules["../renderer/impl/css/level0/screen.coffee"]};
var require = getModule.bind(null, {});
var exports = module.exports;
...
return module.exports;
})();modules['../renderer/impl/css/level0/navigator.coffee'] = (function(){
var module = {exports: modules["../renderer/impl/css/level0/navigator.coffee"]};
var require = getModule.bind(null, {});
var exports = module.exports;
...
return module.exports;
})();modules['../renderer/impl/css/level0/sensor/rotation.coffee'] = (function(){
var module = {exports: modules["../renderer/impl/css/level0/sensor/rotation.coffee"]};
var require = getModule.bind(null, {"/Users/krystian/Projects/Neft/app/node_modules/assert":"../assert/index.coffee.md","assert":"../assert/index.coffee.md"});
var exports = module.exports;
...
(function() {
  ...
  module.exports = function(impl) {
    var degToRad, listener, sensor;
    degToRad = impl.utils.degToRad;
    sensor = null;
    listener = function(e) {
      if (sensor) {
        sensor.x = degToRad(e.beta || 0);
        assert.isFloat(sensor.x);
        sensor.y = degToRad(e.gamma || 0);
        assert.isFloat(sensor.y);
        sensor.z = degToRad(e.alpha || 0);
...
return module.exports;
})();modules['../renderer/impl/css/level1/rectangle.coffee'] = (function(){
var module = {exports: modules["../renderer/impl/css/level1/rectangle.coffee"]};
var require = getModule.bind(null, {});
var exports = module.exports;
...
return module.exports;
})();modules['../renderer/impl/css/level0/sound/ambient.coffee'] = (function(){
var module = {exports: modules["../renderer/impl/css/level0/sound/ambient.coffee"]};
var require = getModule.bind(null, {});
var exports = module.exports;
...
(function() {
  ...
  module.exports = function(impl) {
    ...
    return {
      ...
      startAmbientSound: function(val) {
        this._impl.elem.play();
        if (this._impl.elem.readyState === this._impl.elem.HAVE_ENOUGH_DATA) {
          this._impl.elem.currentTime = 0;
        }
      },
      stopAmbientSound: function(val) {
        this._impl.elem.pause();
      }
    };
  };
  ...
  module.exports = function(Renderer, Impl, itemUtils, Item) {
    return function(ctor) {
      ...
      return ItemDocument = (function(_super) {
        var DocElement, DocTag, DocText, Document, DocumentHideEvent, DocumentShowEvent, disableProperties, enableProperties, onNodeAttrsChange, onPropertyChange, setProperty;
        ...
        setImmediate(function() {
          ...
          return DocText = DocElement.Text;
        });
        ...
        itemUtils.defineProperty({
          ...
          setter: function(_super) {
            return function(val) {
              if (this._node instanceof DocTag) {
...
var require = getModule.bind(null, {"utils":"../utils/index.coffee.md","log":"../log/index.coffee.md","/Users/krystian/Projects/Neft/app/node_modules/assert":"../assert/index.coffee.md","assert":"../assert/index.coffee.md"});
var exports = module.exports;
  ...
  module.exports = function(File, data) {
    ...
    return Style = (function() {
      ...
      Style.createStylesInDocument = (function() {
        ...
        forNode = function(file, node, parentStyle) {
          ...
          if (isText || (attr = node.attrs.get('neft:style'))) {
            ...
            style.attrs = !isText && getStyleAttrs(node);
            if (parentStyle) {
      ...
      Style.prototype.updateVisibility = function() {
        ...
        if (this.node instanceof Text && !this.isTextSet) {
          visible = false;
        } else {
