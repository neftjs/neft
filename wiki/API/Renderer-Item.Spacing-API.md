> [Wiki](Home) ▸ [[API Reference|API-Reference]] ▸ [[Renderer|Renderer-API]] ▸ [[Item|Renderer-Item-API]] ▸ **Spacing**

#Spacing
<dl><dt>Syntax</dt><dd><code>Item.Spacing</code></dd><dt>Static property of</dt><dd><a href="/Neft-io/neft/Renderer-Item-API.md#class-item">Item</a></dd></dl>
...
## [Float](/Neft-io/neft/Utils-API.md#isfloat) Spacing::column = `0`

## [Signal](/Neft-io/neft/Signal-API.md#class-signal) Spacing::onColumnChange([Float](/Neft-io/neft/Utils-API.md#isfloat) oldValue)
...
## [Float](/Neft-io/neft/Utils-API.md#isfloat) Spacing::row = `0`

## [Signal](/Neft-io/neft/Signal-API.md#class-signal) Spacing::onRowChange([Float](/Neft-io/neft/Utils-API.md#isfloat) oldValue)
...
##valueOf
<dl><dt>Syntax</dt><dd><code>&#x2A;Float&#x2A; Spacing::valueOf()</code></dd><dt>Prototype method of</dt><dd><i>Spacing</i></dd><dt>Returns</dt><dd><a href="/Neft-io/neft/Utils-API.md#isfloat">Float</a></dd></dl>
