...
onBeforeRender
<dl><dt>Syntax</dt><dd><code>&#x2A;Signal&#x2A; File.onBeforeRender(&#x2A;File&#x2A; file)</code></dd><dt>Static property of</dt><dd><i>File</i></dd><dt>Parameters</dt><dd><ul><li>file — <i>File</i></li></ul></dd><dt>Type</dt><dd><a href="/Neft-io/neft/wiki/API/Signal-API#class-signal">Signal</a></dd></dl>
...
onRender
<dl><dt>Syntax</dt><dd><code>&#x2A;Signal&#x2A; File.onRender(&#x2A;File&#x2A; file)</code></dd><dt>Static property of</dt><dd><i>File</i></dd><dt>Parameters</dt><dd><ul><li>file — <i>File</i></li></ul></dd><dt>Type</dt><dd><a href="/Neft-io/neft/wiki/API/Signal-API#class-signal">Signal</a></dd></dl>
...
onBeforeRevert
<dl><dt>Syntax</dt><dd><code>&#x2A;Signal&#x2A; File.onBeforeRevert(&#x2A;File&#x2A; file)</code></dd><dt>Static property of</dt><dd><i>File</i></dd><dt>Parameters</dt><dd><ul><li>file — <i>File</i></li></ul></dd><dt>Type</dt><dd><a href="/Neft-io/neft/wiki/API/Signal-API#class-signal">Signal</a></dd></dl>
...
onRevert
<dl><dt>Syntax</dt><dd><code>&#x2A;Signal&#x2A; File.onRevert(&#x2A;File&#x2A; file)</code></dd><dt>Static property of</dt><dd><i>File</i></dd><dt>Parameters</dt><dd><ul><li>file — <i>File</i></li></ul></dd><dt>Type</dt><dd><a href="/Neft-io/neft/wiki/API/Signal-API#class-signal">Signal</a></dd></dl>
...
> [`Source`](/Neft-io/neft/blob/166a8d6faa3ffad1f28cca284e4169ff5ecdee2c/src/document/file.litcoffee#fromhtml)
...
> [`Source`](/Neft-io/neft/blob/166a8d6faa3ffad1f28cca284e4169ff5ecdee2c/src/document/file.litcoffee#fromelement)
...
> [`Source`](/Neft-io/neft/blob/166a8d6faa3ffad1f28cca284e4169ff5ecdee2c/src/document/file.litcoffee#fromjson)
...
> [`Source`](/Neft-io/neft/blob/166a8d6faa3ffad1f28cca284e4169ff5ecdee2c/src/document/file.litcoffee#parse)
...
> [`Source`](/Neft-io/neft/blob/166a8d6faa3ffad1f28cca284e4169ff5ecdee2c/src/document/file.litcoffee#factory)
...
> [`Source`](/Neft-io/neft/blob/166a8d6faa3ffad1f28cca284e4169ff5ecdee2c/src/document/file.litcoffee#render)
...
onReplaceByUse
<dl><dt>Syntax</dt><dd><code>&#x2A;Signal&#x2A; File::onReplaceByUse(&#x2A;File.Use&#x2A; use)</code></dd><dt>Prototype method of</dt><dd><i>File</i></dd><dt>Parameters</dt><dd><ul><li>use — <i>File.Use</i></li></ul></dd><dt>Type</dt><dd><a href="/Neft-io/neft/wiki/API/Signal-API#class-signal">Signal</a></dd></dl>
...
toJSON
<dl><dt>Syntax</dt><dd><code>&#x2A;Object&#x2A; File::toJSON()</code></dd><dt>Prototype method of</dt><dd><i>File</i></dd><dt>Returns</dt><dd><a href="/Neft-io/neft/wiki/API/Utils-API#isobject">Object</a></dd></dl>
