...
class Scrollable: Item {
    ...
    override func measure(var globalTransform: CGAffineTransform, _ viewRect: CGRect, inout _ dirtyRects: [CGRect], forceUpdateBounds: Bool = false) {
        ...
        if contentItem != nil {
            ...
            if forceChildrenUpdate || letDirtyChildren {
                ...
                contentItem!.measure(globalTransform, self.viewRect, &self.dirtyRects, forceUpdateBounds: forceChildrenUpdate)
