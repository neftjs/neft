...
exports.compileFile = function (file, filename) {
    ...
    case '.nml': {
        ...
        require('src/nml-parser').bundle(nmlFile);
        return CoffeeScript.compile(nmlFile.data);
    }
    default:
        return file;
    }
...
exports.getFile = function (filename) {
    const log = filename === '/Users/krystian/Projects/quickciv/build/styles/_views/views/Actions/Index.xhtml#0.nml';

    log && console.log('REQUIRE');
