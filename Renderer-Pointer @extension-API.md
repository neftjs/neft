...
Pointer
<dl><dt>Syntax</dt><dd>Pointer @extension</dd></dl>
```nml
`Rectangle {
`   width: 100
`   height: 100
...
Pointer
<dl><dt>Syntax</dt><dd>*Pointer* Pointer()</dd><dt>Returns</dt><dd><i>Pointer</i></dd></dl>
...
enabled
<dl><dt>Syntax</dt><dd>*Boolean* Pointer::enabled = true</dd><dt>Prototype property of</dt><dd><i>Pointer</i></dd><dt>Type</dt><dd><i>Boolean</i></dd><dt>Default</dt><dd><code>true</code></dd></dl>
...
draggable
<dl><dt>Syntax</dt><dd>Hidden *Boolean* Pointer::draggable = false</dd><dt>Prototype property of</dt><dd><i>Pointer</i></dd><dt>Type</dt><dd><i>Boolean</i></dd><dt>Default</dt><dd><code>false</code></dd><dt>Hidden</dt></dl>
...
dragActive
<dl><dt>Syntax</dt><dd>Hidden *Boolean* Pointer::dragActive = false</dd><dt>Prototype property of</dt><dd><i>Pointer</i></dd><dt>Type</dt><dd><i>Boolean</i></dd><dt>Default</dt><dd><code>false</code></dd><dt>Hidden</dt></dl>
...
onClick
<dl><dt>Syntax</dt><dd>[*Signal*](/Neft-io/neft/wiki/Signal-API.md#class-signal) Pointer::onClick(*PointerEvent* event)</dd><dt>Prototype method of</dt><dd><i>Pointer</i></dd><dt>Parameters</dt><dd><ul><li>event — <i>PointerEvent</i></li></ul></dd><dt>Returns</dt><dd><i>Signal</i></dd></dl>
...
pressed
<dl><dt>Syntax</dt><dd>*Boolean* Pointer::pressed = false</dd><dt>Prototype property of</dt><dd><i>Pointer</i></dd><dt>Type</dt><dd><i>Boolean</i></dd><dt>Default</dt><dd><code>false</code></dd></dl>
Whether the pointer is currently pressed.

##onPressedChange
<dl><dt>Syntax</dt><dd>[*Signal*](/Neft-io/neft/wiki/Signal-API.md#class-signal) Pointer::onPressedChange(*Boolean* oldValue)</dd><dt>Prototype method of</dt><dd><i>Pointer</i></dd><dt>Parameters</dt><dd><ul><li>oldValue — <i>Boolean</i></li></ul></dd><dt>Returns</dt><dd><i>Signal</i></dd></dl>
...
hover
<dl><dt>Syntax</dt><dd>*Boolean* Pointer::hover = false</dd><dt>Prototype property of</dt><dd><i>Pointer</i></dd><dt>Type</dt><dd><i>Boolean</i></dd><dt>Default</dt><dd><code>false</code></dd></dl>
Whether the pointer is currently under the item.

##onHoverChange
<dl><dt>Syntax</dt><dd>[*Signal*](/Neft-io/neft/wiki/Signal-API.md#class-signal) Pointer::onHoverChange(*Boolean* oldValue)</dd><dt>Prototype method of</dt><dd><i>Pointer</i></dd><dt>Parameters</dt><dd><ul><li>oldValue — <i>Boolean</i></li></ul></dd><dt>Returns</dt><dd><i>Signal</i></dd></dl>
...
PointerEvent
<dl><dt>Syntax</dt><dd>*PointerEvent* PointerEvent() : *DevicePointerEvent*</dd><dt>Extends</dt><dd><i>DevicePointerEvent</i></dd><dt>Returns</dt><dd><i>PointerEvent</i></dd></dl>
Events order:
 1. Press
 2. Enter
 3. Move
...
stopPropagation
<dl><dt>Syntax</dt><dd>*Boolean* PointerEvent::stopPropagation = false</dd><dt>Prototype property of</dt><dd><i>PointerEvent</i></dd><dt>Type</dt><dd><i>Boolean</i></dd><dt>Default</dt><dd><code>false</code></dd></dl>
...
checkSiblings
<dl><dt>Syntax</dt><dd>*Boolean* PointerEvent::checkSiblings = false</dd><dt>Prototype property of</dt><dd><i>PointerEvent</i></dd><dt>Type</dt><dd><i>Boolean</i></dd><dt>Default</dt><dd><code>false</code></dd></dl>
...
ensureRelease
<dl><dt>Syntax</dt><dd>*Boolean* PointerEvent::ensureRelease = true</dd><dt>Prototype property of</dt><dd><i>PointerEvent</i></dd><dt>Type</dt><dd><i>Boolean</i></dd><dt>Default</dt><dd><code>true</code></dd></dl>
...
ensureMove
<dl><dt>Syntax</dt><dd>*Boolean* PointerEvent::ensureMove = true</dd><dt>Prototype property of</dt><dd><i>PointerEvent</i></dd><dt>Type</dt><dd><i>Boolean</i></dd><dt>Default</dt><dd><code>true</code></dd></dl>
...
event
<dl><dt>Syntax</dt><dd>*PointerEvent* Pointer.event</dd><dt>Static property of</dt><dd><i>Pointer</i></dd><dt>Type</dt><dd><i>PointerEvent</i></dd></dl>
